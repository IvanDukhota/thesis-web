...
import type { LocalMessage } from '../../../../pages/ChatPage/ChatsPage';
      ...
      >
        <div className="message-context-menu__actions">
          {canEdit && (
            ...
            >
              <span className="message-context-menu__icon"><RiEditLine size={15} /></span>
              <span className="message-context-menu__label">Edit</span>
            </button>
          )}
          ...
          >
            <span className="message-context-menu__icon"><RiReplyLine size={15} /></span>
            <span className="message-context-menu__label">Reply</span>
          </button>
          ...
          >
            <span className="message-context-menu__icon"><RiShareForwardLine size={15} /></span>
            <span className="message-context-menu__label">Forward</span>
          </button>
          ...
          {targetType === 'text' && hasText && (
            ...
            >
              <span className="message-context-menu__icon"><RiFileCopyLine size={15} /></span>
              <span className="message-context-menu__label">Copy text</span>
            </button>
          )}
          ...
          {targetType === 'image' && targetAttachment && (
            ...
            >
              <span className="message-context-menu__icon"><RiImageLine size={15} /></span>
              <span className="message-context-menu__label">Copy image</span>
            </button>
          )}
          ...
          {(targetType === 'image' || targetType === 'file' || targetType === 'video') && targetAttachment && (
            ...
            >
              <span className="message-context-menu__icon"><RiDownload2Line size={15} /></span>
              <span className="message-context-menu__label">Download</span>
            </button>
          )}
          ...
          {canDelete && (
            <>
              ...
              >
                <span className="message-context-menu__icon"><RiDeleteBin6Line size={15} /></span>
                <span className="message-context-menu__label">Delete</span>
              </button>
            </>
          )}
        </div>
        ...
        {showReadBy && (
          <>
            ...
            <div className="message-context-menu__read-by">
              <div className="message-context-menu__read-by-label">Read by:</div>
        ...
        {message.edited_at && (
          <>
            ...
            <div className="message-context-menu__info">
              <span className="message-context-menu__info-label">Edited:</span>
