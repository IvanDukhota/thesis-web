...
const DROPDOWN_ITEMS = [
    ...
    { icon: <RiChat3Line size={15} />, label: "Chat" },
    { icon: <RiBellLine size={15} />, label: "Notifications" },
];
        ...
        <header className={`header ${hidden ? "header--hidden" : ""}`}>
            ...
            <div className="profile-wrapper" ref={dropdownRef}>
                ...
                <div className={`header-dropdown ${open ? "header-dropdown--open" : ""}`}>
                    {DROPDOWN_ITEMS.map(({ icon, label }) => (
                        <button key={label} className="header-dropdown-item">
                    ...
                    <button className="header-dropdown-item header-dropdown-item--logout">
